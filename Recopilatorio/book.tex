...
\centering{\LARGE\textbf{Leones(0,0,0)}} \\[0.5cm]
...
\cppfile{../data_structures/lazy_segtree.cpp}

\subsection{Segment tree - Persistence}
\cppfile{../data_structures/persistent_segtree.cpp}
...
\cppfile{../graphs/dynamic_conn.cpp}

% \subsection{Edmond's blossom (matching in general graphs)}
% \cppfile{../graphs/edmon_blossom.cpp}

\subsection{Dominator tree}
\cppfile{../graphs/dominator.cpp}
...
\subsection{Hashing}
\cppfile{../strings/hash_128.cpp}

\subsection{Manacher}
\cppfile{../strings/manacher.cpp}

\subsection{Aho-Corasick}
\cppfile{../strings/aho_crystal.cpp}
...
\subsection{Dinic Crystal}
\cppfile{../flow/dinic_crystal.cpp}

\subsection{Min cost max flow}
\cppfile{../flow/MCMF.cpp}

\subsection{Min cost max flow cycles}
\cppfile{../flow/MCMF_cycles.cpp}
